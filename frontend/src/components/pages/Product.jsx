    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row'>
        ...
        <div className='flex-1'>
              ...
              {productData.colors.map((colorObj, index) => (
                <button
                  ...
                  onClick={() => {
                    ...
                    setMainImage(colorObj.image ? colorObj.image[0] : productData.image[0]);
                  }}
                  ...
                  .sizes.map((sizeObj, index) => (
                    <button
                      ...
                      className={`border py-2 px-4 bg-gray-100 ${
                        sizeObj.size === selectedSize ? 'border-orange-500' : ''
                      }`}
                    >
          ...
          {/* Add to Cart */}
          <button
            onClick={() => addToCart(productData._id, selectedColor, selectedSize)}
            className='bg-black text-white px-8 py-3 active:bg-gray-700 mt-4'
